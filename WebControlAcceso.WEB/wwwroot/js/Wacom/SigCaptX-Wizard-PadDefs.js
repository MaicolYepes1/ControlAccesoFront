...
WACOMVARIABLES = JSON.parse(localStorage.getItem("WACOMVARIABLES"));
...
function screen_Display1(pad, buttonTextSource) {
    ...
    this.stepMsg1.textString = WACOMVARIABLES.tituloPaso1;
    ...
    this.infoText.textString = WACOMVARIABLES.txtDeclaracion;
...
function screen_Display3(pad, buttonTextSource) {
    ...
    this.stepMsg3.textString = WACOMVARIABLES.tituloPaso2;
    ...
    this.pleaseSign.textString = WACOMVARIABLES.tituloFirma;
    ...
    this.who.textString = WACOMVARIABLES.pieDeFirma1;
    this.who.type = "who";
    ...
    this.why.type = "why";
    this.why.textString = WACOMVARIABLES.pieDeFirma2;
...
function setupContinueText(pad, buttonTextSource) {
    ...
    if (buttonTextSource == textSource.LOCAL || buttonTextSource == textSource.REMOTE) {
        nextToContinue.textString = WACOMVARIABLES.nextButton;
    }
    else {
        if (pad.Range == padRange.STU300) {
            nextToContinue.textString = WACOMVARIABLES.nextButton;
